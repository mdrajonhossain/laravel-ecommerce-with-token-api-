...
<html lang="en">
    ...
    <body class="sb-nav-fixed">        
        ...
        <div id="brand_view" class="brand_view" style="display: none">
          <button class="brand_close" onclick="brand()">Close</button>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="" style="padding: 20px 0px 20px 0px">                        
                        <h4 style="color:#666d7c">Brand Forms</h4>
                        <button class="btn btn-info" onclick="brand()">Manage Brand</button>
                        <hr/>
                    </div>
                                             
                            <form action="{{url('admin/addbrand')}}" method="post" enctype= multipart/form-data>
                                @csrf
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="file" class="form-control" name="brandimage" id="inputPassword">
                                </div>
                              </div>
...
<script>
  ...
  function brand() {
  var x = document.getElementById("brand_view");
